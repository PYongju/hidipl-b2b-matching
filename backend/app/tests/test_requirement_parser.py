...
1. 수수료모델 5%
2. 고객사: 일강이앤아이
3. 견적 요청 내용: 회의실 내 태양광 발전 현황 확인을 위한 비디오월 or LED 전광판 고려 중
(1) 46" 비디오월 3x3
(2) LED P1.56 3,000 x 2,000mm
4. 일정: 3개월 내외
5. 지역: 충북 음성
6. 단계: 견적 확인 후 내부 보고 예정
"""


SAMPLE_2 = """신규 프로젝트 연결드립니다.
...
def test_file_samples() -> None:
    file_samples = sorted(DATA_DIR.glob("*요청내용*.png"))

    for index, file_path in enumerate(file_samples, start=1):
